...
import {announcing_and_Reporting_data} from './DomAttributes'
...
function Reporting() {
    ...
    return (
        ...
        <h1 className='text-1xl my-5 mx-auto w-[90%] relative font-bold underline-offset-3 underline'>{Languages[selected_language].lan_choose},</h1>
            <div className='w-[90%] flex flex-col grow-0 my-5 mx-auto '>
                <form onSubmit={handleSubmit(HandleSubmit)}>    
                    {announcing_and_Reporting_data.map(({name , type , id , value , error,patern , required}) => {
                        return(
                        <div key={`${id} + 32`}>
                            <InputField
                            value={value}
