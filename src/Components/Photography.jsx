...
import FirstPhotographer from './FirstPhotographer';
import ArialPhotography from './ArialPhotography';
import MobilePhotography from './MobilePhotography';
...
function Photography() {
    ...
    <div className='xl:absolute w-full left-[15%] xl:w-[70%] xl:top-[10%] xl:h-[80%] xl:border xl:shadow-2xl xl:rounded-2xl xl:overflow-y-scroll '>
        ...
        {/* {Fields.is_dslr_mirrorless_photographer && <FirstPhotographer/>}
        {Fields.is_arial_photographer && <ArialPhotography/>} */}
        <MobilePhotography/>
    </div>
    )
}
